...
var xObject = JSON.parse(x); //重新把字符串变成对象

var hashMap = xObject || [//parcel会默认在代码外面加作用域
{
  logo: 'A',
...
var simplifyUrl = function simplifyUrl(url) {
  return url.replace('https://', '').replace('http://', '').replace('www.', '').replace(/\/.*/, ''); //正则表达式，，删除/开头得内容
};
...
window.onbeforeunload = function () {
  // console.log('页面要关闭了')
  var string = JSON.stringify(hashMap); //把hashMap对象变成字符串
...
//# sourceMappingURL=main.1eb5945a.js.map